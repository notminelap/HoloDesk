...
/// All calls are proxied through the secure backend to prevent key exposure.
actor GeminiService {
    
    static let shared = GeminiService()
    
    private let model = "gemini-2.0-flash"
    private let baseURL = "https://api.holodesk.ai/v1/gemini"
    ...
    func chat(message: String, workspaceContext: String? = nil) async throws -> String {
        ...
        // Make API call (proxied securely without API key in URL)
