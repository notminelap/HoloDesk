...
// MARK: - Whiteboard App Content

/// Interactive whiteboard with drawing tools.
struct WhiteboardAppContent: View {
    @State private var lines: [[CGPoint]] = []
    @State private var currentLine: [CGPoint] = []
    @State private var selectedColor: Color = .white
    @State private var strokeWidth: CGFloat = 2
    
    private let colors: [Color] = [.white, .red, .blue, .green, .yellow, .orange, .purple]
        ...
        VStack(spacing: 0) {
            ...
            HStack(spacing: 8) {
                ...
                HStack(spacing: 4) {
                    ...
                    Slider(value: $strokeWidth, in: 1...8)
                        .frame(width: 60)
    ...
    private func drawLine(_ points: [CGPoint], in context: inout GraphicsContext) {
        ...
        context.stroke(path, with: .color(selectedColor), style: StrokeStyle(lineWidth: strokeWidth, lineCap: .round, lineJoin: .round))
    }
}
